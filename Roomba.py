...
from utils.Image_Grid import create_map
from utils.path_finding import Grid, AStarFinder, DiagonalMovement
...
SELECT_PATH = './assets/selection.png'
ROOMBA_PATH = './assets/roomba.png'
...
class Pathfinder:
    def __init__(self, matrix):
        ...
        self.select_surf = pygame.image.load(SELECT_PATH).convert_alpha()
...
class Roomba(pygame.sprite.Sprite):
    def __init__(self, empty_path):
        ...
        # basic
        super().__init__()
        self.image = pygame.image.load(ROOMBA_PATH).convert_alpha()
...
if __name__ == '__main__':
    # game setup
    bg_surf = pygame.image.load(MAP_PATH).convert()

    # load map
    matrix = create_map(MAP_PATH)
